        ...
        <>
            <div className={'error'}>
                <div className={'error__content'}>
                    <Title className={'error__title'}>Страница не найдена</Title>
                    <Title className={'error__subtitle'} >Ошибка 404</Title>
            ...
            <div className={'error__info'}>
                <Text>Запрашиваемая вами страница не найдена.</Text>
